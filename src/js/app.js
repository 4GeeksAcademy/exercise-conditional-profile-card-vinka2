...
function render(variables = {}) {
  ...
  if (variables.lastName == null) variables.lastName = "Your last name";
  ...
  document.querySelector("#widget_content").innerHTML = `<div class="widget">
          ...
          <h1 style="font-size: 22px;">${variables.name} ${variables.lastName}</h1>
...
window.onload = function() {
  window.variables = {
    ...
    background: "https://wallpapercave.com/wp/wp8963442.jpg",
    // this is the url for the profile avatar
    avatarURL:
      "https://media.licdn.com/dms/image/D4E03AQEHyikTey4Vcg/profile-displayphoto-shrink_200_200/0/1705617971045?e=2147483647&v=beta&t=vSdrg5xzSkrLTjo6D3V112pNdePq3QsuYISKWfzlZFg",
